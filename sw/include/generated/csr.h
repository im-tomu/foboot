//--------------------------------------------------------------------------------
// Auto-generated by Migen (f4fcd10) & LiteX (8b7d8217) on 2019-09-20 20:03:26
//--------------------------------------------------------------------------------
...
#define CSR_MESSIBLE_CTRL_ADDR 0xe000800cL
#define CSR_MESSIBLE_CTRL_SIZE 1
static inline unsigned char messible_ctrl_read(void) {
	unsigned char r = csr_readl(0xe000800cL);
	return r;
}
static inline void messible_ctrl_write(unsigned char value) {
	csr_writel(value, 0xe000800cL);
}
#define CSR_MESSIBLE_CTRL_ADV_OFFSET 0
#define CSR_MESSIBLE_CTRL_ADV_SIZE 1
...
#define CSR_USB_SETUP_CTRL_ADVANCE_OFFSET 0
#define CSR_USB_SETUP_CTRL_ADVANCE_SIZE 1
...
#define CSR_USB_IN_STATUS_PEND_OFFSET 7
...
#define CSR_USB_OUT_CTRL_ADVANCE_OFFSET 0
#define CSR_USB_OUT_CTRL_ADVANCE_SIZE 1
